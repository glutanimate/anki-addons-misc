# -*- coding: utf-8 -*-
# Utility functions that do the actual heavy lifting of this addon.
"""
...
def todayStats_new(self):
    ...
    if self.type == 0:
        period = 31
        name = u"<strong>Past month</strong>"
    elif self.type == 1:
        period = 365
        name = u"<strong>Past year</strong>"
    elif self.type == 2:
        period = float('inf')
        name = u"<strong>All time</strong>"

    pastPeriod = statList(self, lim, (self.col.sched.dayCutoff - 86400 * period) * 1000)

    return todayStats_old(self) + u"<br><br><table style='text-align: center; margin: 0 auto;'><tr><td style='padding: 5px'>" \
